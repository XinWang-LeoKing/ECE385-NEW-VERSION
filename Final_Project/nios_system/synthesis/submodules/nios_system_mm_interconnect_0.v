...
module nios_system_mm_interconnect_0 (
	...
	wire  [109:0] keycode0_s1_agent_rf_source_data;                                                   // keycode0_s1_agent:rf_source_data -> keycode0_s1_agent_rsp_fifo:in_data
	...
	wire  [109:0] keycode0_s1_agent_rsp_fifo_out_data;                                                // keycode0_s1_agent_rsp_fifo:out_data -> keycode0_s1_agent:rf_sink_data
	...
	wire          cmd_mux_013_src_valid;                                                              // cmd_mux_013:src_valid -> keycode0_s1_agent:cp_valid
	wire  [108:0] cmd_mux_013_src_data;                                                               // cmd_mux_013:src_data -> keycode0_s1_agent:cp_data
	wire          cmd_mux_013_src_ready;                                                              // keycode0_s1_agent:cp_ready -> cmd_mux_013:src_ready
	wire   [17:0] cmd_mux_013_src_channel;                                                            // cmd_mux_013:src_channel -> keycode0_s1_agent:cp_channel
	wire          cmd_mux_013_src_startofpacket;                                                      // cmd_mux_013:src_startofpacket -> keycode0_s1_agent:cp_startofpacket
	wire          cmd_mux_013_src_endofpacket;                                                        // cmd_mux_013:src_endofpacket -> keycode0_s1_agent:cp_endofpacket
	...
	wire          cmd_mux_014_src_valid;                                                              // cmd_mux_014:src_valid -> keycode1_s1_agent:cp_valid
	wire  [108:0] cmd_mux_014_src_data;                                                               // cmd_mux_014:src_data -> keycode1_s1_agent:cp_data
	wire          cmd_mux_014_src_ready;                                                              // keycode1_s1_agent:cp_ready -> cmd_mux_014:src_ready
	wire   [17:0] cmd_mux_014_src_channel;                                                            // cmd_mux_014:src_channel -> keycode1_s1_agent:cp_channel
	wire          cmd_mux_014_src_startofpacket;                                                      // cmd_mux_014:src_startofpacket -> keycode1_s1_agent:cp_startofpacket
	wire          cmd_mux_014_src_endofpacket;                                                        // cmd_mux_014:src_endofpacket -> keycode1_s1_agent:cp_endofpacket
	...
	wire  [108:0] cmd_mux_015_src_data;                                                               // cmd_mux_015:src_data -> keycode2_s1_agent:cp_data
	wire          cmd_mux_015_src_ready;                                                              // keycode2_s1_agent:cp_ready -> cmd_mux_015:src_ready
	wire   [17:0] cmd_mux_015_src_channel;                                                            // cmd_mux_015:src_channel -> keycode2_s1_agent:cp_channel
	...
	wire  [108:0] cmd_mux_016_src_data;                                                               // cmd_mux_016:src_data -> keycode3_s1_agent:cp_data
	wire          cmd_mux_016_src_ready;                                                              // keycode3_s1_agent:cp_ready -> cmd_mux_016:src_ready
	wire   [17:0] cmd_mux_016_src_channel;                                                            // cmd_mux_016:src_channel -> keycode3_s1_agent:cp_channel
	...
	wire  [108:0] cmd_mux_017_src_data;                                                               // cmd_mux_017:src_data -> keycode4_s1_agent:cp_data
	wire          cmd_mux_017_src_ready;                                                              // keycode4_s1_agent:cp_ready -> cmd_mux_017:src_ready
	wire   [17:0] cmd_mux_017_src_channel;                                                            // cmd_mux_017:src_channel -> keycode4_s1_agent:cp_channel
	...
	wire          keycode0_s1_agent_rp_valid;                                                         // keycode0_s1_agent:rp_valid -> router_015:sink_valid
	wire  [108:0] keycode0_s1_agent_rp_data;                                                          // keycode0_s1_agent:rp_data -> router_015:sink_data
	wire          keycode0_s1_agent_rp_ready;                                                         // router_015:sink_ready -> keycode0_s1_agent:rp_ready
	wire          keycode0_s1_agent_rp_startofpacket;                                                 // keycode0_s1_agent:rp_startofpacket -> router_015:sink_startofpacket
	wire          keycode0_s1_agent_rp_endofpacket;                                                   // keycode0_s1_agent:rp_endofpacket -> router_015:sink_endofpacket
	...
	wire          keycode1_s1_agent_rp_valid;                                                         // keycode1_s1_agent:rp_valid -> router_016:sink_valid
	wire  [108:0] keycode1_s1_agent_rp_data;                                                          // keycode1_s1_agent:rp_data -> router_016:sink_data
	wire          keycode1_s1_agent_rp_ready;                                                         // router_016:sink_ready -> keycode1_s1_agent:rp_ready
	wire          keycode1_s1_agent_rp_startofpacket;                                                 // keycode1_s1_agent:rp_startofpacket -> router_016:sink_startofpacket
	wire          keycode1_s1_agent_rp_endofpacket;                                                   // keycode1_s1_agent:rp_endofpacket -> router_016:sink_endofpacket
	...
	wire  [108:0] keycode2_s1_agent_rp_data;                                                          // keycode2_s1_agent:rp_data -> router_017:sink_data
	...
	wire  [108:0] keycode3_s1_agent_rp_data;                                                          // keycode3_s1_agent:rp_data -> router_018:sink_data
	...
	wire  [108:0] keycode4_s1_agent_rp_data;                                                          // keycode4_s1_agent:rp_data -> router_019:sink_data
	...
	wire          keycode0_s1_agent_rdata_fifo_src_valid;                                             // keycode0_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_013:in_0_valid
	wire   [33:0] keycode0_s1_agent_rdata_fifo_src_data;                                              // keycode0_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_013:in_0_data
	wire          keycode0_s1_agent_rdata_fifo_src_ready;                                             // avalon_st_adapter_013:in_0_ready -> keycode0_s1_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_013_out_0_valid;                                                  // avalon_st_adapter_013:out_0_valid -> keycode0_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_013_out_0_data;                                                   // avalon_st_adapter_013:out_0_data -> keycode0_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_013_out_0_ready;                                                  // keycode0_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_013:out_0_ready
	wire    [0:0] avalon_st_adapter_013_out_0_error;                                                  // avalon_st_adapter_013:out_0_error -> keycode0_s1_agent:rdata_fifo_sink_error
	wire          keycode1_s1_agent_rdata_fifo_src_valid;                                             // keycode1_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_014:in_0_valid
	wire   [33:0] keycode1_s1_agent_rdata_fifo_src_data;                                              // keycode1_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_014:in_0_data
	wire          keycode1_s1_agent_rdata_fifo_src_ready;                                             // avalon_st_adapter_014:in_0_ready -> keycode1_s1_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_014_out_0_valid;                                                  // avalon_st_adapter_014:out_0_valid -> keycode1_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_014_out_0_data;                                                   // avalon_st_adapter_014:out_0_data -> keycode1_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_014_out_0_ready;                                                  // keycode1_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_014:out_0_ready
	wire    [0:0] avalon_st_adapter_014_out_0_error;                                                  // avalon_st_adapter_014:out_0_error -> keycode1_s1_agent:rdata_fifo_sink_error
	...
	nios_system_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clk_0_clk_clk),                                  // in_clk_0.clk
		.in_rst_0_reset (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (keycode0_s1_agent_rdata_fifo_src_data),          //     in_0.data
		.in_0_valid     (keycode0_s1_agent_rdata_fifo_src_valid),         //         .valid
		.in_0_ready     (keycode0_s1_agent_rdata_fifo_src_ready),         //         .ready
